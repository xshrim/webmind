...
export const UI_TEXT = {
  ...
  en: {
    ...
    immersiveTranslationShortcutHelp:
      "The paragraph shortcut is for a selection or paragraph, while the page shortcut translates the whole page.",
    shortcutNone: "None",
    shortcutAlt: "Alt",
    shortcutCtrlAlt: "Ctrl+Alt",
    navChat: "Chat",
  ...
  ja: {
    ...
    immersiveTranslationShortcutHelp:
      "段落は選択範囲または段落内容、ページはページ全体の翻訳に使います。",
    shortcutNone: "なし",
    shortcutAlt: "Alt",
    shortcutCtrlAlt: "Ctrl+Alt",
    navChat: "チャット",
  ...
  ko: {
    ...
    immersiveTranslationShortcutHelp:
      "문단은 선택 영역 또는 문단 내용에 사용하고, 페이지는 전체 페이지 번역에 사용합니다.",
    shortcutNone: "없음",
    shortcutAlt: "Alt",
    shortcutCtrlAlt: "Ctrl+Alt",
    navChat: "대화",
