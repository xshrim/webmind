...
const CORE_UI_TEXT = {
  "zh-CN": {
    ...
    defaultContextScopeHelp:
      "控制沉浸翻译和沉浸阅读的贴边菜单与快捷键默认处理当前正文还是当前页面。",
  ...
  "zh-TW": {
    ...
    defaultContextScopeHelp:
      "控制沉浸翻譯和沉浸閱讀的貼邊選單與快捷鍵預設處理目前正文還是目前頁面。",
  ...
  en: {
    ...
    defaultContextScopeHelp:
      "Controls whether immersive translation and immersive reading edge-menu actions and shortcuts process the current body or the current page by default.",
  ...
  ja: {
    ...
    defaultContextScopeHelp:
      "イマーシブ翻訳とイマーシブ読書の端メニューおよびショートカットが、既定で現在の本文または現在のページのどちらを処理するかを制御します。",
  ...
  ko: {
    ...
    defaultContextScopeHelp:
      "몰입 번역과 몰입 읽기의 가장자리 메뉴 및 단축키가 기본적으로 현재 본문 또는 현재 페이지 중 무엇을 처리할지 제어합니다.",
