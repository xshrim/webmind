export const itUiText = {
  ...
  todoPageEyebrow: "Attività",
  localTodosTitle: "Attività",
  todosTitle: "Attività",
  todoItemsTitle: "Elenco attività",
  todoAdd: "Aggiungi attività",
  todoEdit: "Modifica attività",
  todoContent: "Contenuto",
  todoSplit: "Dividi con l'IA",
  todoSplitRunning: "Divisione dell'attività con l'IA",
  todoSplitInvalid: "Il modello non ha restituito almeno due attività valide",
  todoSplitSuccess: "Attività divisa",
  todoSplitSystemPrompt: "Dividi l'attività fornita dall'utente in più attività indipendenti ed eseguibili. Restituisci solo un array JSON di stringhe, senza Markdown o spiegazioni. Restituisci da 2 a 20 elementi. Non inventare attività non supportate dal testo originale.",
  todoSearchPlaceholder: "Cerca attività",
  todoFilter: "Filtro attività",
  todoAll: "Tutte",
  todoOpen: "Aperte",
  ...
  todoInProgressDisabled: "Le attività completate non possono essere segnate come in corso",
  todoExpand: "Espandi attività",
  todoCollapse: "Comprimi attività",
  todoContentExpand: "Espandi contenuto",
  todoContentCollapse: "Comprimi contenuto",
  todoDelete: "Elimina attività",
  todoClearCompleted: "Cancella completate",
  todoClearAll: "Cancella tutte le attività",
  todoEmpty: "Nessuna attività",
  todoEmptyHelp: "Crea un'attività dalla selezione, dal menu contestuale o qui.",
  todoNoSearchResults: "Nessuna attività corrispondente",
  todoCreatedFromSelection: "Dal testo selezionato",
  todoCreatedManually: "Creata manualmente",
  todoSaved: "Aggiunta alle attività",
  todoTitleRequired: "Inserisci il contenuto dell'attività",
  logTodoSplit: "Attività divisa con l'IA",
  messageAddToTodo: "Aggiungi la risposta alle attività",
  logTodoCreated: "Attività creata",
  logTodoUpdated: "Attività aggiornata",
  logTodoCompleted: "Attività completata",
  logTodoReopened: "Attività riaperta",
  logTodoDeleted: "Attività eliminata",
  logTodoCleared: "Attività completate cancellate",
  logTodoAllCleared: "Tutte le attività cancellate",
  addSelectionToTodo: "Aggiungi alle attività",
  ...
  selectionFixedTools: "Strumenti fissi della selezione",
  ...
  searchOpenMode: "Modalità di apertura della ricerca",
  ...
  toolSurfaceContextMenu: "Menu contestuale",
  toolSurfaceContextMenuHelp: "Scegli gli strumenti del sottomenu WebMind nel menu contestuale. Chiedi nella barra laterale è sempre il primo elemento.",
  ...
  historySessions: "Sessioni della cronologia",
  ...
  contextMenuAsk: "Chiedi nella barra laterale",
